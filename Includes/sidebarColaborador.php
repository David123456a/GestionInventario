        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand LOGO  -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="homeColaborador.php">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="homeColaborador.php">
           ...
           <!-- INVENTARIO INVENTARIO INVENTARIO INVENTARIO Gestion de productos CRUD --> 
            ...
            <li class="nav-item">
                ...
                <div id="menu1" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="mostrarProductoColaborador.php">Mostrar productos</a>
            ...
            <li class="nav-item">
                ...
                <div id="menu3" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href= mostrarMovimientoColaborador.php>Mostrar Movimientos</a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="controlUsuariosColaborador.php">
                    <i class="fas fa-fw fa-table"></i>
                    <span>Control de usuarios</span></a>
            </li>
            <!--FIN Nav Item - TaBLes USUARIOS  USUARIOS USUARIOS -->
